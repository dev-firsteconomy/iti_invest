...
main {
    ...
    <section class="section" id="home">
        <div class="banner mob-top-space">
            <img src="images/banner.jpg" class="hidden-xs" alt="">
            <img src="images/banner.jpg" class="visible-xs">
...
<section class="section_inner good_company " id="good_company">
        ...
        <div class="container"> 
            <div class="testimonial-slider owl-carousel owl-theme">
                <div class="item">
                    <div class=""> 
                       <img src="images/customer_testimonial/1.jpg" width="90%">  
                   </div>
                </div>
                <div class="item">
                    <div class=""> 
                       <img src="images/customer_testimonial/2.jpg" width="90%">  
                   </div>
                </div>

                <div class="item">
                    <div class=""> 
                       <img src="images/customer_testimonial/3.jpg" width="90%">  
                   </div>
                </div>

                <div class="item">
                    <div class=""> 
                       <img src="images/customer_testimonial/4.jpg" width="90%">  
                   </div>
                </div>

                 <div class="item">
                    <div class=""> 
                       <img src="images/customer_testimonial/5.jpg" width="90%">  
                   </div>
                </div>              
            </div>
        </div>
