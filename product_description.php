...
<head>
	...
	<?php if($companies['url'] == 'http://www.fortune.co.in/'){?>
		<div class="top_marquee">
			<div class="container-fluid">
					<marquee direction="left" scrollamount="3" behavior="loop" onmouseover="this.stop();" onmouseout="this.start();">
				    “ As per NPCI Circular No.013 dated 11-Sep-2020, Customer can cancel the active NACH mandate of Loan by sending the request at nach@itiorg.com along with loan number and bank details used for repayment of loan(s).”
				  </marquee>
			</div>
		</div>
		<?php } ?>
					...
					<?php if(!empty($row_product))
						...
						<div class="panel-group" id="accordion">
						    <div class="panel panel-default">
						      <div class="panel-heading <?php if(!empty($value['product_title'])){echo preg_replace("|\s+|","", preg_replace("|[^a-zA-Z0-9\']|","",preg_replace("|\-|","",$value['product_title'])));}?>" data-id='<?php if(!empty($value['product_title'])){echo preg_replace("|\s+|","", preg_replace("|[^a-zA-Z0-9\']|","",preg_replace("|\-|","",$value['product_title'])));}?>' title="<?php if(!empty($value['product_title'])){echo preg_replace("|\s+|","", preg_replace("|[^a-zA-Z0-9\']|","",preg_replace("|\-|","",$value['product_title'])));}?>" id="heading_<?php echo $key; ?>" >
	...
	<section class="section_inner section_team">
		<div class="container section_team_container">
				...
				<div class="col-md-12 trustee_team">
					<div class="col-md-6 col-sm-6 block_manage">
						...
						<div class="team_detail1">
							Mr. Sudhir Valia is a member of the Institute of Chartered Accountants of India
							and carries more than three decades of experience in taxation and finance. He
								has been a Director of Sun Pharmaceuticals Industries Ltd. since the inception of
								the company and was instrumental in the excellent growth and profitability of the
										company over the last two decades. He is also on the Board of Taro
											Pharmaceuticals Ltd. He was awarded the CNBC TV18 ‘CFO of the Year’ in the
									Pharmaceutical and Healthcare Sectors for two consecutive years (2011 and
									2012). He has also been awarded the Adivasi Sevak Puraskar (2008-09) by the
							Government of Maharashtra. Mr. Sudhir Valia is also the mentor and one of the
											shareholders of ITI Group.
					...
					<div class="col-md-6 col-sm-6 block_manage">
						...
						<div class="team_detail1">
							Mr. T. P. Ostwal is a Chartered Accountant and in practice for last 40 years. He
							is a Senior Partner of M/s T. P. Ostwal & Associates LLP & DTS & Associates and
							on the board of several companies. He has experience in FEMA Tax,
							International Tax, Transfer Pricing, Valuation, etc. Mr. Ostwal was one of the
							members of Govt. of India’s committee drafting Transfer Pricing Regulations in
							India in 2001. Mr. Ostwal is a visiting professor at Vienna University Austria for
							teaching International tax for LLM studies and is a member of Transfer Pricing
							sub-committee of UN since inception. He was a member of the Expert
							Committee set up by the Central Board for Direct Taxes for framing transfer
							pricing regulations in India. He has authored various books on a range of
							subjects covering International Taxation, Transfer Pricing and Black Money Law
							in India. He is a member on the board of reputed companies.
					...
					<div class="col-md-6 col-sm-6 block_manage">
						...
						<div class="team_detail1">
							Mr. Naushad Panjwani is a Founder & Managing Partner at Mandarus Partners
							focusing on cross-border Mergers & Acquisitions Transaction Advisory. He has
							served as a Senior Executive Director for Knight Frank India and is a member of
					...
					<div class="col-md-6 col-sm-6 block_manage">
						...
						<div class="team_detail1">
							Ms. Priti Savla is a Chartered Accountant and a fellow member of ICAI, New
							Delhi. She is also a qualified Information System Auditor and holds a certificate
							in entrepreneur’s development program from Indian School of Business (ISB),
							Hyderabad and on Forensic Accounting and Fraud Prevention from the ICAI.
							She is a partner in K P B & Associates, Chartered Accountants and a director in
							Perch Strategic Advisors Private Ltd. and Perch Foundation. She is serving as
							an Independent director on the board of listed companies, Aarti Industries Ltd.
							and Aarti Drugs Ltd. She is a Chairperson of the WIRC of the ICAI, serving as the
							Regional Council member of WIRC of ICAI since 2013-14. She is a member on
							various committees and life member of the professional organizations and
							social organization - Chamber of Tax Consultants, Bombay Chartered
							Accountants’ Society. Ms. Savla has an exposure about 20 years in the areas of
							strategic planning, business advisory, process set up, risk mitigation and
							project finance.
                                                ...
                                                <div class="grievance-address col-lg-12">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <p class="addr">To,
                                                            ...
                                                            <br> ITI House, Building no. 36,
                                                            	Dr. R. K. Shirodkar Marg,
                                                             Parel,Mumbai 400012
                                                             Maharashtra India
                                                           
                                                        </p>
                                                        <p class="contact">Contact No: <a href="tel:022-40273600">022-40273600</a> / Email ID: <a href="mailto:viren.rami@itiorg.com">viren.rami@itiorg.com</a></p>
                                            ...
                                            <div class="row">
                                             ...
                                             <div class="row">
                                            	<div class="terms col-lg-12">
                                            		...
                                            		<div class="col-lg-12">
                                            			<p>Privacy policy - FIAFL <a class="" href="privacy-policy-FIAFL.php" >Click Here</a></p>
                                            		</div>
                                            	</div>
                                            </div>
			...
			<div class="<?php if($row_product[0]['company'] == 'Fortune Integrated Assets Finance Limited'){ echo "hide"; }?>"><div class="text-center">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 form-group">
						<select name="company_name_select" id="company_name_select" class="form-control">
                            ...
                            <option value="<?php echo $cp['company_name']; ?>"><?php echo $cp['company_name']; ?></option>
                            <?php  } ?>
						</select>
					</div>
